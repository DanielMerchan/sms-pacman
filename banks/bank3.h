extern const unsigned char	player_tiles_bin[4736];
#define				player_tiles_bin_size 4736
...
extern const unsigned char	sfx_bonus_bounce_psg[22];
#define				sfx_bonus_bounce_psg_size 22
