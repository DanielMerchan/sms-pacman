...
extern const unsigned char	cut_scene_tiles_bin[640];
#define				cut_scene_tiles_bin_size 640
#define				cut_scene_tiles_bin_bank 4
extern const unsigned char	audio_they_meet_psg[636];
#define				audio_they_meet_psg_size 636
#define				audio_they_meet_psg_bank 4
extern const unsigned char	audio_energizer_psg[502];
#define				audio_energizer_psg_size 502
#define				audio_energizer_psg_bank 4
extern const unsigned char	audio_after_ghost_chomped_psg[295];
#define				audio_after_ghost_chomped_psg_size 295
#define				audio_after_ghost_chomped_psg_bank 4
extern const unsigned char	audio_ready_psg[290];
#define				audio_ready_psg_size 290
#define				audio_ready_psg_bank 4
extern const unsigned char	audio_junior_psg[278];
#define				audio_junior_psg_size 278
#define				audio_junior_psg_bank 4
extern const unsigned char	audio_extra_life_psg[245];
#define				audio_extra_life_psg_size 245
#define				audio_extra_life_psg_bank 4
extern const unsigned char	audio_player_chomped_psg[183];
#define				audio_player_chomped_psg_size 183
#define				audio_player_chomped_psg_bank 4
extern const unsigned char	sfx_ghost_chomped_psg[83];
#define				sfx_ghost_chomped_psg_size 83
#define				sfx_ghost_chomped_psg_bank 4
extern const unsigned char	sfx_bonus_chomped_psg[69];
#define				sfx_bonus_chomped_psg_size 69
#define				sfx_bonus_chomped_psg_bank 4
extern const unsigned char	audio_bgm_psg[35];
#define				audio_bgm_psg_size 35
#define				audio_bgm_psg_bank 4
extern const unsigned char	sfx_confirm_psg[34];
#define				sfx_confirm_psg_size 34
