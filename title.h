...
void set_title(void) {
	...
	set_ghost(INDEX_BLINKY, DIRECTION_LEFT, ENTITY_STATE_SCENE, 256, 200);
	set_ghost(INDEX_PINKY, DIRECTION_LEFT, ENTITY_STATE_SCENE, 256, 200);
	set_ghost(INDEX_INKY, DIRECTION_LEFT, ENTITY_STATE_SCENE, 256, 200);
	set_ghost(INDEX_SUE, DIRECTION_LEFT, ENTITY_STATE_SCENE, 256, 200);
...
void update_title_marquee(unsigned char index) {
...
void update_title_entities(void) {
	...
	update_title_marquee(0);
	update_title_marquee(1);
	update_title_marquee(2);
	update_title_marquee(3);
	update_title_marquee(4);
	update_title_marquee(5);
...
void move_title_character(unsigned char index, unsigned char x, unsigned char y) {
...
void update_title_game_mode(void) {
...
void update_title_stage_select(void) {
...
void update_title(void) {
	...
	if (SubState < 11 && KeysPressed & PORT_A_KEY_1) {
		play_sfx(SFX_CONFIRM, SFX_CHANNELS2AND3);
		SubState = 11;
	}
	switch (SubState) {
		...
		// Introduce Blinky
		case 1:
			move_title_character(INDEX_BLINKY, 56, 52);
		break;
		// Load Pinky
		case 2:
		...
		// Introduce Pinky
		case 3:
			move_title_character(INDEX_PINKY, 56, 68);
		break;
		// Load Inky
		case 4:
			SMS_loadTileMapArea(14, 11, title_clear, 6, 1);
		...
		// Introduce Inky
		case 5:
			move_title_character(INDEX_INKY, 56, 84);
		break;
		// Load Sue
		case 6:
			SMS_loadTileMapArea(14, 11, title_clear, 6, 1);
		...
		// Introduce Sue
		case 7:
			move_title_character(INDEX_SUE, 56, 100);
		break;
		// Load Ms Pac Man
		case 8:
		...
		case 9:
			move_title_character(INDEX_PLAYER_01, 136, 120);
		break;
